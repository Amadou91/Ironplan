...
create table if not exists public.exercise_catalog (
  ...
  -- focus is a generated column, computed from primary_muscle via derive_focus_from_muscle()
  focus text generated always as (public.derive_focus_from_muscle(primary_muscle)) stored,
