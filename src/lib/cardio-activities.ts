...
export const CARDIO_ACTIVITY_OPTIONS: Array<{ value: CardioActivity; label: string; keywords: string[] }> = [
  ...
  { value: 'indoor_cycling', label: 'Indoor Cycling', keywords: ['indoor cycling', 'spin', 'indoor ride'] },
  { value: 'outdoor_cycling', label: 'Outdoor Cycling', keywords: ['outdoor cycling', 'road cycling', 'bike ride', 'outdoor ride'] },
]
