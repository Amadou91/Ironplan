import { EquipmentInventory, Exercise, Goal } from '@/types/domain';
...
// Utility to perform the actual swap in a list of exercises
export const swapExerciseInSession = (
    exercises: Exercise[], 
    targetId: string, 
    newExercise: Exercise
): Exercise[] => {
    return exercises.map(ex => ex.id === targetId ? newExercise : ex);
};